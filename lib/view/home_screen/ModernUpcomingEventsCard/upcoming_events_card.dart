...
//         giftSuggestions: ['Sweets', 'Diyas', 'Jewelry', 'Gold Coins', 'Rangoli Sets'],
//         isRecurring: true,
...
//         type: EventType.festival,
//         icon: Icons.favorite,
//         giftSuggestions: ['Flowers', 'Jewelry', 'Spa Items', 'Personalized Gifts'],
//       ),
//       Event(
...
//   static Future<void> updateUserEvent(String eventId, Event updatedEvent) async {
//     final events = await getUserEvents();
...
//                         // Gift Suggestions
//                         if (event.giftSuggestions != null && event.giftSuggestions!.isNotEmpty) ...[
//                           SizedBox(height: 24),
//                           Text(
//                             "🎁 Gift Ideas",
//                             style: TextStyle(
...
//           // Gift Categories
//           Expanded(
//             child: event.giftSuggestions != null && event.giftSuggestions!.isNotEmpty
//               ? ListView.builder(
//                   padding: EdgeInsets.all(16),
...
//                         subtitle: Text('Perfect for ${event.title.toLowerCase()}'),
//                         trailing: Icon(Icons.arrow_forward_ios),
//                         onTap: () {
//                           // Navigate to specific gift category
//                           _navigateToGiftCategory(context, giftCategory, event);
//                         },
//                       ),
//                     );
//                   },
...
//     } else if (categoryLower.contains('sweet') || categoryLower.contains('cake')) {
//       return Icons.cake;
//     } else if (categoryLower.contains('clothes') || categoryLower.contains('saree')) {
...
//   void _navigateToGiftCategory(BuildContext context, String category, Event event) {
//     // Navigate to your main gift category screen with filters
//     // Example: Get.to(() => GiftCategoryScreen(category: category, event: event));
//     ScaffoldMessenger.of(context).showSnackBar(
//       SnackBar(content: Text('Opening $category gifts...')),
//     );
//   }
// }
...
//     return plans.map((plan) => jsonDecode(plan) as Map<String, dynamic>).toList();
//   }
// }
...
//       final upcomingUserEvents = await EventsService.getUpcomingUserEvents(days: 30);
