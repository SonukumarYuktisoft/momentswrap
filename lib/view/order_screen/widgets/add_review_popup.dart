...
class _AddReviewPopupState extends State<AddReviewPopup> {    
  ...
  bool get _isFormValid => _rating > 0 && _commentController.text.trim().isNotEmpty;
            ...
            children: [    
                  ...
                  return GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Icon(
                        ...
                        color: _rating >= starIndex ? Colors.amber : Colors.grey[400],
                        size: 32,
                      ),
                    ),
                  );    
              ...
              Row(    
                ...
                children: [    
                  ...
                  Obx(    
                    () => ElevatedButton(    
                      onPressed: (_isFormValid && !_reviewController.isSubmitting.value) 
                          ? _submitReview
                          : null,    
