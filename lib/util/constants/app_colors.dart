...
class AppColors {
  static const Color primaryColor = Color(0xFF31354E);
  static const Color primaryForegroundColor = Color(0xFFF5F5F5);

  // static const Color primaryColor = Color(0xFFE594A3);
  static const Color secondaryColor = Color(0xFF31354E);
  static const Color secondaryForegroundColor = Color(0xFFF5F5F5);
